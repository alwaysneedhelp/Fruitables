...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'title', 'product_image', 'price', 'category', 'vendor', 'feautured', 'product_status']
...
class CouponAdmin(admin.ModelAdmin):
    list_display = ['code', 'off', 'discount', 'active']
    list_editable = ['off', 'discount', 'active']
